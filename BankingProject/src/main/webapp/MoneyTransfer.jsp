...
<title>Money Transfer Successfully</title>
<style type="text/css">
...
NewUserBean tubean=(NewUserBean)application.getAttribute("tubean");
%>
...
<header>
	...
	<div class="box data"> 
		...
		<p><%=amount %> has been transferd to account number <%=tubean.getAccountNo() %>.</p>
		<p>Your Current balance is <%=ubean.getAmount() %> </p>
		<p>Thank You!!!</p>
